use super::signatures::naive_multisig::{XfrPublicKey, XfrSecretKey, KEY_BASE_POINT};
...
pub fn hybrid_decrypt(ctext: &ZeiHybridCipher,
...
fn symmetric_key_from_secret_key(sec_key: &XfrSecretKey,
...
#[cfg(test)]
mod test {
  use super::super::signatures::naive_multisig::XfrKeyPair;
  use super::*;
