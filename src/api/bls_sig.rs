...
pub fn bls_sign<B: AsRef<[u8]>>(signing_key: &BlsSecretKey, message: &B) -> BlsSignature {
  crate::basic_crypto::signatures::bls::bls_sign::<BLSGt, B>(signing_key, message)
}
...
pub fn bls_verify<B: AsRef<[u8]>>(ver_key: &BlsPublicKey,
                                  ...
                                  -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls::bls_verify::<BLSGt, B>(ver_key, message, signature)
}
...
pub fn bls_verify_aggregated<B: AsRef<[u8]>>(ver_keys: &[&BlsPublicKey],
                                             ...
                                             -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls::bls_verify_aggregated::<BLSGt, B>(ver_keys,
                                                                          message,
                                                                          agg_signature)
}
...
pub fn bls_batch_verify<B: AsRef<[u8]>>(ver_keys: &[BlsPublicKey],
                                        ...
                                        -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls::bls_batch_verify::<BLSGt, B>(ver_keys, messages, signatures)
}
...
pub fn bls_batch_verify_added_signatures<B: AsRef<[u8]>>(ver_keys: &[BlsPublicKey],
                                                         ...
                                                         signature: &BlsSignature)
                                                         -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls::bls_batch_verify_added_signatures::<BLSGt, B>(ver_keys,
                                                                                      messages,
                                                                                      signature)
}
