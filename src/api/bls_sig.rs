...
pub type BlsSecretKey = crate::basic_crypto::signatures::BlsSecretKey<BLSGt>;
pub type BlsPublicKey = crate::basic_crypto::signatures::BlsPublicKey<BLSGt>;
pub type BlsSignature = crate::basic_crypto::signatures::BlsSignature<BLSGt>;

/// bls key generation function
pub fn bls_gen_keys<R: CryptoRng + Rng>(prng: &mut R) -> (BlsSecretKey, BlsPublicKey) {
  crate::basic_crypto::signatures::bls_gen_keys::<_, BLSGt>(prng)
}

/// bls signature function
pub fn bls_sign(signing_key: &BlsSecretKey, message: &[u8]) -> BlsSignature {
  crate::basic_crypto::signatures::bls_sign::<BLSGt>(signing_key, message)
}
...
pub fn bls_verify(ver_key: &BlsPublicKey,
                  ...
                  -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls_verify::<BLSGt>(ver_key, message, signature)
}
...
pub fn bls_aggregate(ver_keys: &[BlsPublicKey], signatures: &[BlsSignature]) -> BlsSignature {
  crate::basic_crypto::signatures::bls_aggregate::<BLSGt>(ver_keys, signatures)
}
...
pub fn bls_verify_aggregated(ver_keys: &[BlsPublicKey],
                             ...
                             -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls_verify_aggregated::<BLSGt>(ver_keys, message, agg_signature)
}
...
pub fn bls_batch_verify(ver_keys: &[BlsPublicKey],
                        ...
                        -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls_batch_verify::<BLSGt>(ver_keys, messages, signatures)
}

/// signature aggregation for (possibly) different messages
pub fn bls_add_signatures(signatures: &[BlsSignature]) -> BlsSignature {
  crate::basic_crypto::signatures::bls_add_signatures::<BLSGt>(signatures)
}
...
pub fn bls_batch_verify_added_signatures(ver_keys: &[BlsPublicKey],
                                         ...
                                         signature: &BlsSignature)
                                         -> Result<(), ZeiError> {
  crate::basic_crypto::signatures::bls_batch_verify_added_signatures::<BLSGt>(ver_keys, messages,
                                                                              signature)
}
