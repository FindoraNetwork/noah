...
use crate::xfr::structs::{AssetRecord, AssetIssuerPubKeys, OpenAssetRecord, BlindAssetRecord};
use crate::utils::{u64_to_u32_pair, u64_to_bigendian_u8array, u8_bigendian_slice_to_u128, u8_bigendian_slice_to_u64};
...
pub fn build_blind_asset_record<R: CryptoRng + Rng>(
    prng: &mut R,
    pc_gens: &PedersenGens,
    asset_record: &AssetRecord,
    confidential_amount: bool,
