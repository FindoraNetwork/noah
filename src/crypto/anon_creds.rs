...
pub(crate) fn ac_user_key_gen<R: CryptoRng + RngCore, P: Pairing>(
  prng: &mut R,
...
pub(crate) fn ac_sign<R: CryptoRng + RngCore, P: Pairing>(
  prng: &mut R,
...
pub(crate) fn ac_commitment_key_gen<R: CryptoRng + RngCore, P: Pairing>(
  prng: &mut R)
  -> ACKey<P::ScalarField> {
