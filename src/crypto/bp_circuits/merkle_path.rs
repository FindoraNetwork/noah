...
mod test{
    ...
    fn test_bp_merkle_inclusion(){
        ...
        super::merkle_verify_mimc(&mut prover, var_elem, &var_path[..],merkle_root.value, Scalar::from(merkle_root.size as u64) ).unwrap();
        ...
        super::merkle_verify_mimc(&mut verifier, ver_var_elem, &ver_var_path[..],merkle_root.value, Scalar::from(merkle_root.size as u64)).unwrap();
