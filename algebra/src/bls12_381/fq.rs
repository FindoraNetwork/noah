...
use ark_ff::{BigInteger, BigInteger384, FftField, Field, FpParameters, PrimeField};
use ark_std::{
    fmt::{Debug, Formatter},
...
impl Debug for BLSFq {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        <BigUint as Debug>::fmt(
            &<BigInteger384 as Into<BigUint>>::into(self.0.into_repr()),
            f,
        )
    }
}
...
impl Scalar for BLSFq {
    ...
    #[inline]
    fn capacity() -> usize {
        FqParameters::CAPACITY as usize
    }
