...
impl AnonBlindAssetRecord {
  pub fn from_oabar(oabar: &OpenAnonBlindAssetRecord) -> AnonBlindAssetRecord {
    ...
    AnonBlindAssetRecord { amount_type_commitment: oabar.compute_commitment(),
...
impl OpenAnonBlindAssetRecordBuilder {
  ...
  pub fn new() -> Self {
    OpenAnonBlindAssetRecordBuilder { ..Default::default() }
  }
  ...
  pub fn finalize<R: CryptoRng + RngCore>(mut self,
                                          prng: &mut R,
                                          enc_key: &XPublicKey)
    ...
    let memo = OwnerMemo { blind_share: Default::default(),
                           lock: cipher };
...
impl OpenAnonBlindAssetRecordBuilder {
  ...
  pub fn from_abar(record: &AnonBlindAssetRecord,
