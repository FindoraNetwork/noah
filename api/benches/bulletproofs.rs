...
use zei_crypto::bulletproofs::mix::{self, MixCommitment, MixVariable};

// Measurement of the verification time and batch verification time of Range/Mix Bulletproofs in Zei
fn main() {
...
fn bench_verify_asset_mixer() {
    ...
    println!(
        "verify mix bulletproofs takes time: {} s",
...
fn bench_batch_verify_asset_mixer(count: usize) {
    ...
    println!(
        "batch verify of {} mix bulletproofs takes time: {} s", count,
        start.elapsed().as_secs_f32() / count as f32
    );
}
