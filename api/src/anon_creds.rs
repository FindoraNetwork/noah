...
type G2 = BLSG2;
type S = BLSScalar;
pub type ACIssuerPublicKey = zei_crypto::anon_creds::ACIssuerPublicKey<G1, G2>;
pub type ACIssuerSecretKey = zei_crypto::anon_creds::ACIssuerSecretKey<G1, S>;

pub type ACSignature = zei_crypto::anon_creds::ACSignature<G1>;

pub type ACUserPublicKey = zei_crypto::anon_creds::ACUserPublicKey<G1>;

pub type ACUserSecretKey = zei_crypto::anon_creds::ACUserSecretKey<S>;

pub type ACRevealSig = zei_crypto::anon_creds::ACRevealSig<G1, G2, S>;

pub type ACPoK = zei_crypto::anon_creds::ACPoK<G2, S>;

pub type ACCommitmentKey = zei_crypto::anon_creds::ACKey<S>;

pub type ACCommitment = zei_crypto::anon_creds::ACCommitment<G1>;

pub type Credential = zei_crypto::anon_creds::Credential<G1, G2, Attr>;

pub type ACRevealProof = zei_crypto::anon_creds::ACRevealProof<G2, S>;
...
pub fn ac_keygen_issuer<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_keygen_issuer::<_, BLSPairingEngine>(prng, num_attrs)
}
...
pub fn ac_keygen_user<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_user_key_gen::<_, BLSPairingEngine>(prng, issuer_pk)
}
...
pub fn ac_sign<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_sign::<_, BLSPairingEngine>(
        prng,
        issuer_sk,
        user_pk,
...
pub fn ac_keygen_commitment<R: CryptoRng + RngCore>(prng: &mut R) -> ACCommitmentKey {
    zei_crypto::anon_creds::ac_commitment_key_gen::<_, BLSPairingEngine>(prng)
}
...
pub fn ac_commit<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_commit::<_, BLSPairingEngine>(prng, user_sk, &c, msg).c(d!())
}
...
pub fn ac_commit_with_key<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_commit_with_key::<_, BLSPairingEngine>(prng, user_sk, &c, key, msg)
        .c(d!())
}
...
pub fn ac_verify_commitment(
    ...
    zei_crypto::anon_creds::ac_verify_commitment::<BLSPairingEngine>(
        issuer_pub_key,
        sig_commitment,
        sok,
        msg,
...
pub fn ac_open_commitment<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_open_commitment::<_, BLSPairingEngine>(
...
pub fn ac_reveal<R: CryptoRng + RngCore>(
    ...
    zei_crypto::anon_creds::ac_reveal::<_, BLSPairingEngine>(prng, user_sk, &c, reveal_bitmap)
        .c(d!())
}
...
pub fn ac_verify(
    ...
    zei_crypto::anon_creds::ac_verify::<BLSPairingEngine>(
        issuer_pub_key,
        attrs_scalar.as_slice(),
        &sig_commitment,
        &reveal_proof,
...
pub fn ac_confidential_open_commitment<R: CryptoRng + RngCore>(
    ...
    zei_crypto::conf_cred_reveal::ac_confidential_open_commitment::<R, BLSPairingEngine>(
...
pub fn ac_confidential_verify(
    ...
    zei_crypto::conf_cred_reveal::ac_confidential_open_verify::<BLSPairingEngine>(
        issuer_pk,
        enc_key,
        reveal_map,
        sig_commitment,
