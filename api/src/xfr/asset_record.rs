...
use noah_algebra::{prelude::*, ristretto::{RistrettoScalar, PedersenCommitmentRistretto}};
...
mod test {
    ...
    use noah_algebra::{prelude::*, traits::PedersenCommitment, ristretto::{PedersenCommitmentRistretto, RistrettoScalar}};
