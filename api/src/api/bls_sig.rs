...
use zei_crypto::basics::signatures::{AggSignature, Signature};

pub type BlsSecretKey = zei_crypto::basics::signatures::bls::BlsSecretKey<BLSPairingEngine>;
pub type BlsPublicKey = zei_crypto::basics::signatures::bls::BlsPublicKey<BLSPairingEngine>;
pub type BlsSignature = zei_crypto::basics::signatures::bls::BlsSignature<BLSPairingEngine>;

/// bls key generation function
pub fn bls_gen_keys<R: CryptoRng + RngCore>(prng: &mut R) -> (BlsSecretKey, BlsPublicKey) {
    zei_crypto::basics::signatures::bls::bls_gen_keys::<_, BLSPairingEngine>(prng)
}

/// bls signature function
pub fn bls_sign<B: AsRef<[u8]>>(signing_key: &BlsSecretKey, message: &B) -> BlsSignature {
    zei_crypto::basics::signatures::bls::bls_sign::<BLSPairingEngine, B>(signing_key, message)
}
...
pub fn bls_verify<B: AsRef<[u8]>>(
    ...
    zei_crypto::basics::signatures::bls::bls_verify::<BLSPairingEngine, B>(
...
pub fn bls_aggregate(ver_keys: &[&BlsPublicKey], signatures: &[&BlsSignature]) -> BlsSignature {
    zei_crypto::basics::signatures::bls::bls_aggregate::<BLSPairingEngine>(ver_keys, signatures)
}
...
pub fn bls_verify_aggregated<B: AsRef<[u8]>>(
    ...
    zei_crypto::basics::signatures::bls::bls_verify_aggregated::<BLSPairingEngine, B>(
        ver_keys,
        message,
        agg_signature,
    )
...
pub fn bls_batch_verify<B: AsRef<[u8]>>(
    ...
    zei_crypto::basics::signatures::bls::bls_batch_verify::<BLSPairingEngine, B>(
...
pub fn bls_add_signatures(signatures: &[BlsSignature]) -> BlsSignature {
    zei_crypto::basics::signatures::bls::bls_add_signatures::<BLSPairingEngine>(signatures)
}
...
pub fn bls_batch_verify_added_signatures<B: AsRef<[u8]>>(
    ...
    zei_crypto::basics::signatures::bls::bls_batch_verify_added_signatures::<BLSPairingEngine, B>(
